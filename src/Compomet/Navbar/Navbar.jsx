      ...
      <div className="flex items-center justify-between mx-auto p-4 ">
        ...
        <div className="lg:flex items-center space-x-6 rtl:space-x-reverse">
          {token ? (
            <>
              {cartCounter ? (
                <div className="top-3 z-10 absolute sm:right-[40px] xsm:right-[80px] md:right-[90px] lg:right-[112px] bg-red-500 flex-col rounded-[50%] w-5 h-5 flex items-center justify-center">
                  <span className="text-white">{cartCounter}</span>
                </div>
              ) : null}
              {wishList ? (
                <div className="top-3 z-10 absolute sm:right-[80px] xsm:right-[120px] md:right-[130px] lg:right-[155px] bg-yellow-500 flex-col rounded-[50%] w-5 h-5 flex items-center justify-center">
